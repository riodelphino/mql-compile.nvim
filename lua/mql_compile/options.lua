...
M.default = {
   ...
   highlights = { -- Highlights on quickfix window
      enabled = true,
      hlgroups = {
         filename = { name = 'qfFileName', opts = { link = 'Directory' } },
         separator_left = { name = 'qfSeparatorLeft', opts = { fg = '#cccccc' } },
         separator_right = { name = 'qfSeparatorRight', opts = { fg = '#cccccc' } },
         line_nr = { name = 'qfLineNr', opts = { fg = '#888888' } },
         col = { name = 'qfCol', opts = { fg = '#888888' } },
         error = { name = 'qfError', opts = { fg = '#0033FF' } },
         warning = { name = 'qfWarning', opts = { link = 'DiagnosticWarn' } },
         info = { name = 'qfInfo', opts = { link = 'DiagnosticInfo' } },
         hint = { name = 'qfHint', opts = { link = 'DiagnosticHint' } },
         note = { name = 'qfNote', opts = { link = 'DiagnosticHint' } },
         code = { name = 'qfCode', opts = { fg = '#888888' } },
         text = { name = 'qfText', opts = { link = 'Normal' } },
      },
   },
}
